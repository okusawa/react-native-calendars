...
class CalendarHeader extends Component {
  ...
  render() {
    ...
    const optionalDayHeaderStyle = idx => {
      switch (idx) {
        case 0:
          return this.style.dayHeaderSunday;
        case 6:
          return this.style.dayHeaderSaturday;
        default:
          return {};
      }
    };
          ...
          <View style={this.style.week}>
            ...
            {weekDaysNames.map((day, idx) => (
              <Text
                ...
                key={idx}
                accessible={false}
                style={[this.style.dayHeader, optionalDayHeaderStyle(idx)]}
                numberOfLines={1}
